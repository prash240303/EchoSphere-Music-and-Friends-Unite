  ...
  return (
    <div className='flex-grow h-screen'>
      ...
      <div onScroll={(e) => changeOpacity(e.target.scrollTop)} className='relative -top-20 h-screen overflow-y-scroll bg-neutral-900'>
        <section className={`flex items-end space-x-7 bg-gradient-to-b to-neutral-900 ${color} h-80 text-white py-8`}>
          <div className='flex items-center justify-center overflow-y-hidden w-full h-80'>
            {artistData && <img className='w-full  aspect-auto ' src={artistData.images[0].url} />}
          </div>
